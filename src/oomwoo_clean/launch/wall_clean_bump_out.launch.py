...
See docs/wall-follow-bump-out.md for the behavior. This is the bump-out clean
under its own name; wall_clean.launch.py is reserved for the fully-featured
